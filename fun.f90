...
102     print *, 'error of reading file "input_fortran.in"'; pause; stop
    ...
    subroutine ode4f()
        ...
        integer(c_int) i, j, l, aiparf(1), aiparp(1), itp, method, ifail
        real(c_double) :: t, z, artolf(1), aatolf(1), arparf(1), artolp(1), aatolp(1), arparp(1), xoutp, hstart, tstart, twant, tgot
    ...
    subroutine dfdt(t, f, s)
        ...
        real(c_double) t, z, f(*), yp(neqp), s(*), xoutp, &
